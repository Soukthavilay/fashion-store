        ...
        <div className="footer-container">
          ...
          <div className="copyright">
            <svg width="164" height="42" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <path id="a" d="M28.205.16H.196v39.064h28.009V.159z"></path>
                <path id="c" d="M60.007 28.001V.084H.009v27.917z"></path>
              </defs>
            ...
            <div className="copyright-content">2021 © LAO COMPANY</div>
          </div>
        </div>
      </div>
    </>
